...
>
  ...
  >
    ...
    <h3 class="text-xl sm:text-2xl font-bold text-pink-600 dark:text-pink-400 mb-4 text-center">{producto.nombre}</h3>
    ...
    <p class="text-lg sm:text-xl font-bold text-pink-600 dark:text-pink-400 mt-5 text-center">{producto.precio}</p>
...
<style>
  ...
  .animate-modal { animation: modal 0.4s ease-out both; }
  .animate-blur-in { animation: blur-in 0.4s ease-out both; }
  .close-button { animation: fade-in-scale 0.3s ease-out both; animation-delay: 0.15s; }
